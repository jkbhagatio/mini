...
def plot_latent_tuning(
    ...
    unit_acts = acts_df[(acts_df['instance_idx'] == instance_idx) & (acts_df['latent_idx'] == latent_idx)]
    ...
    if 'angle' in variable:  # Polar plot
        ...
        fig.update_layout(title=f"Instance {instance_idx} Unit {latent_idx} & Top Neuron {top_neuron} & Bottom Neuron {bottom_neuron}", showlegend=True, height=800, width=1600, margin=dict(t=80, b=60, l=50, r=50))
        ...
        fig.update_layout(title=f"Instance {instance_idx} Unit {latent_idx} & Top Neuron {top_neuron} & Bottom Neuron {bottom_neuron}", height=800, width=1600, showlegend=True, margin=dict(t=80, b=60, l=50, r=50))
...
def build_feature_finding_dashboard(
    ...
    def _refresh_unit_options(*_):
        ...
        units = sorted(unit_metadata_mapping.loc[mask, 'latent_idx'].unique())
